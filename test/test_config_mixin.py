...
import paddle
from paddle_geometric.config_mixin import ConfigMixin
from paddle_geometric.config_store import clear_config_store, register
...
class Base(paddle.nn.Layer, ConfigMixin):
    pass
...
def test_config_mixin() -> None:
    ...
    model = Module(x, data)
    """Not Support auto convert *.config, please judge whether it is Pytorch API and convert by yourself"""
    cfg = model.config()
